                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="employee_2/booking_2.php" method="POST">
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="form-group pb-2">
                                                    ...
                                                    <input type="date" name="datetime"
                                                        class="form-control form-control-user" placeholder="Enter Date"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="no_of_visitor"
                                                class="form-control form-control-user"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="img" name="img" accept="image/*"
                                                class="form-control " placeholder="Photo" style="border: none;">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline  mr-3">
                                                <input type="radio" class="form-control form-control-user"
                                                    name="optradio">Personal
                                            </label>
                                            <label class="radio-inline  mr-3">
                                                <input type="radio" class="form-control form-control-user"
                                                    name="optradio">Industrial
                                            </label>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline mr-3">
                                                <input type="radio" class="form-control form-control-user"
                                                    name="optradio1">Breakfast
                                            </label>
                                            <label class="radio-inline mr-3">
                                                <input type="radio" class="form-control form-control-user"
                                                    name="optradio1">Lunch
                                            </label>
                                            <label class="radio-inline  mr-3">
                                                <input type="radio" class="form-control form-control-user"
                                                    name="optradio1">Dinner
                                            </label>
                                        </div>
                                        <div class="form-group">
                                            <button class="btn btn-custom form-toggle" type="button"
                                        ...
                                        <input type="submit" name="login_btn" class="btn btn-primary btn-user btn-block"
                                            style="border-radius: 10rem;" value="Book">
                                        <hr>
                                    </form>
